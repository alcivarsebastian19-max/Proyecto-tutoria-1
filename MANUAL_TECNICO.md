...
Error al compilar en Linux: reemplazar conio.h no es necesario; el código ya tiene un bloque alternativo con termios.h para Linux/Mac mediante #ifdef _WIN32.
